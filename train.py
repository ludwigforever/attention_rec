...
def main():
    ...
    embedding = Dense(n_hidden_units, activation='tanh', name='embedding', kernel_regularizer=regularizers.l2(0.001), bias_regularizer=regularizers.l2(0.001))(noise)
    ...
    out = Dense(n_movies, activation='softmax', kernel_regularizer=regularizers.l2(0.001), bias_regularizer=regularizers.l2(0.001), name='out')(multi)
