...
class RecModel(object):
    ...
    def build(self):
        ...
        '''
        self_rnn_out=Self_RNN(self.n_hidden_units, input_shape=(self.max_length,self.n_hidden_units), dropout=0.4, name='Self_RNN')(embedding)
    ...
    def modelCompile(self, model, op):
        model.summary()
        model.compile(loss='categorical_crossentropy', optimizer=op, metrics=[top_10_CCE])
